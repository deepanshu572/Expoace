...
const Footer = () => {
  return (
    <div className="footer bg-[#090909]  text-[#e0cdbdcc] sm:px-30 py-10 px-5 overflow-x-hidden ">
      <div className="top flex relative ">
        {/*  */}
        <div className="top_footer pt-5 py-10 sm:py-5">
          <div className="head font2 relative z-2 ">
            <div className="txt text-6xl sm:text-9xl">Our</div>
            <div className="txt text-6xl sm:text-9xl">Story</div>
